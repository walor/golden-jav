 ...
 */
public class GetBuildRequestDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.urbancode.anthill3.integration.GetBuildRequestDocument
{
    
    public GetBuildRequestDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName GETBUILDREQUEST$0 = 
        new javax.xml.namespace.QName("integration.anthill3.urbancode.com", "getBuildRequest");
    
    
    /**
     * Gets the "getBuildRequest" element
     */
    public com.urbancode.anthill3.integration.GetBuildRequestDocument.GetBuildRequest getGetBuildRequest()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.urbancode.anthill3.integration.GetBuildRequestDocument.GetBuildRequest target = null;
            target = (com.urbancode.anthill3.integration.GetBuildRequestDocument.GetBuildRequest)get_store().find_element_user(GETBUILDREQUEST$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setGetBuildRequest(com.urbancode.anthill3.integration.GetBuildRequestDocument.GetBuildRequest getBuildRequest)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.urbancode.anthill3.integration.GetBuildRequestDocument.GetBuildRequest)get_store().add_element_user(GETBUILDREQUEST$0);
            }
            target.set(getBuildRequest);
        }
    }
     ...
     */
    public com.urbancode.anthill3.integration.GetBuildRequestDocument.GetBuildRequest addNewGetBuildRequest()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class GetBuildRequestImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.urbancode.anthill3.integration.GetBuildRequestDocument.GetBuildRequest
    {
        
        public GetBuildRequestImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
