 ...
 */
public class RunWorkflowDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.urbancode.anthill3.integration.RunWorkflowDocument
{
    
    public RunWorkflowDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName RUNWORKFLOW$0 = 
        new javax.xml.namespace.QName("integration.anthill3.urbancode.com", "runWorkflow");
    
    
    /**
     * Gets the "runWorkflow" element
     */
    public com.urbancode.anthill3.integration.RunWorkflowDocument.RunWorkflow getRunWorkflow()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.urbancode.anthill3.integration.RunWorkflowDocument.RunWorkflow target = null;
            target = (com.urbancode.anthill3.integration.RunWorkflowDocument.RunWorkflow)get_store().find_element_user(RUNWORKFLOW$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setRunWorkflow(com.urbancode.anthill3.integration.RunWorkflowDocument.RunWorkflow runWorkflow)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.urbancode.anthill3.integration.RunWorkflowDocument.RunWorkflow)get_store().add_element_user(RUNWORKFLOW$0);
            }
            target.set(runWorkflow);
        }
    }
     ...
     */
    public com.urbancode.anthill3.integration.RunWorkflowDocument.RunWorkflow addNewRunWorkflow()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class RunWorkflowImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.urbancode.anthill3.integration.RunWorkflowDocument.RunWorkflow
    {
        
        public RunWorkflowImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
