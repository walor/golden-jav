 ...
 */
public class GetWorkflowServerGroupByNameDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.urbancode.anthill3.integration.GetWorkflowServerGroupByNameDocument
{
    
    public GetWorkflowServerGroupByNameDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName GETWORKFLOWSERVERGROUPBYNAME$0 = 
        new javax.xml.namespace.QName("integration.anthill3.urbancode.com", "getWorkflowServerGroupByName");
    
    
    /**
     * Gets the "getWorkflowServerGroupByName" element
     */
    public com.urbancode.anthill3.integration.GetWorkflowServerGroupByNameDocument.GetWorkflowServerGroupByName getGetWorkflowServerGroupByName()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.urbancode.anthill3.integration.GetWorkflowServerGroupByNameDocument.GetWorkflowServerGroupByName target = null;
            target = (com.urbancode.anthill3.integration.GetWorkflowServerGroupByNameDocument.GetWorkflowServerGroupByName)get_store().find_element_user(GETWORKFLOWSERVERGROUPBYNAME$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setGetWorkflowServerGroupByName(com.urbancode.anthill3.integration.GetWorkflowServerGroupByNameDocument.GetWorkflowServerGroupByName getWorkflowServerGroupByName)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.urbancode.anthill3.integration.GetWorkflowServerGroupByNameDocument.GetWorkflowServerGroupByName)get_store().add_element_user(GETWORKFLOWSERVERGROUPBYNAME$0);
            }
            target.set(getWorkflowServerGroupByName);
        }
    }
     ...
     */
    public com.urbancode.anthill3.integration.GetWorkflowServerGroupByNameDocument.GetWorkflowServerGroupByName addNewGetWorkflowServerGroupByName()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class GetWorkflowServerGroupByNameImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.urbancode.anthill3.integration.GetWorkflowServerGroupByNameDocument.GetWorkflowServerGroupByName
    {
        
        public GetWorkflowServerGroupByNameImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
