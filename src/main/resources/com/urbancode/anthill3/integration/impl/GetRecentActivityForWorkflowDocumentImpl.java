 ...
 */
public class GetRecentActivityForWorkflowDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.urbancode.anthill3.integration.GetRecentActivityForWorkflowDocument
{
    
    public GetRecentActivityForWorkflowDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName GETRECENTACTIVITYFORWORKFLOW$0 = 
        new javax.xml.namespace.QName("integration.anthill3.urbancode.com", "getRecentActivityForWorkflow");
    
    
    /**
     * Gets the "getRecentActivityForWorkflow" element
     */
    public com.urbancode.anthill3.integration.GetRecentActivityForWorkflowDocument.GetRecentActivityForWorkflow getGetRecentActivityForWorkflow()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.urbancode.anthill3.integration.GetRecentActivityForWorkflowDocument.GetRecentActivityForWorkflow target = null;
            target = (com.urbancode.anthill3.integration.GetRecentActivityForWorkflowDocument.GetRecentActivityForWorkflow)get_store().find_element_user(GETRECENTACTIVITYFORWORKFLOW$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setGetRecentActivityForWorkflow(com.urbancode.anthill3.integration.GetRecentActivityForWorkflowDocument.GetRecentActivityForWorkflow getRecentActivityForWorkflow)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.urbancode.anthill3.integration.GetRecentActivityForWorkflowDocument.GetRecentActivityForWorkflow)get_store().add_element_user(GETRECENTACTIVITYFORWORKFLOW$0);
            }
            target.set(getRecentActivityForWorkflow);
        }
    }
     ...
     */
    public com.urbancode.anthill3.integration.GetRecentActivityForWorkflowDocument.GetRecentActivityForWorkflow addNewGetRecentActivityForWorkflow()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class GetRecentActivityForWorkflowImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.urbancode.anthill3.integration.GetRecentActivityForWorkflowDocument.GetRecentActivityForWorkflow
    {
        
        public GetRecentActivityForWorkflowImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
