 ...
 */
public class RunWorkflowWithPropertiesByNameDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.urbancode.anthill3.integration.RunWorkflowWithPropertiesByNameDocument
{
    
    public RunWorkflowWithPropertiesByNameDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName RUNWORKFLOWWITHPROPERTIESBYNAME$0 = 
        new javax.xml.namespace.QName("integration.anthill3.urbancode.com", "runWorkflowWithPropertiesByName");
    
    
    /**
     * Gets the "runWorkflowWithPropertiesByName" element
     */
    public com.urbancode.anthill3.integration.RunWorkflowWithPropertiesByNameDocument.RunWorkflowWithPropertiesByName getRunWorkflowWithPropertiesByName()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.urbancode.anthill3.integration.RunWorkflowWithPropertiesByNameDocument.RunWorkflowWithPropertiesByName target = null;
            target = (com.urbancode.anthill3.integration.RunWorkflowWithPropertiesByNameDocument.RunWorkflowWithPropertiesByName)get_store().find_element_user(RUNWORKFLOWWITHPROPERTIESBYNAME$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setRunWorkflowWithPropertiesByName(com.urbancode.anthill3.integration.RunWorkflowWithPropertiesByNameDocument.RunWorkflowWithPropertiesByName runWorkflowWithPropertiesByName)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.urbancode.anthill3.integration.RunWorkflowWithPropertiesByNameDocument.RunWorkflowWithPropertiesByName)get_store().add_element_user(RUNWORKFLOWWITHPROPERTIESBYNAME$0);
            }
            target.set(runWorkflowWithPropertiesByName);
        }
    }
     ...
     */
    public com.urbancode.anthill3.integration.RunWorkflowWithPropertiesByNameDocument.RunWorkflowWithPropertiesByName addNewRunWorkflowWithPropertiesByName()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class RunWorkflowWithPropertiesByNameImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.urbancode.anthill3.integration.RunWorkflowWithPropertiesByNameDocument.RunWorkflowWithPropertiesByName
    {
        
        public RunWorkflowWithPropertiesByNameImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
