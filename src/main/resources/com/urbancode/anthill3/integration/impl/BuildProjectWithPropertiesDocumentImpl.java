 ...
 */
public class BuildProjectWithPropertiesDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.urbancode.anthill3.integration.BuildProjectWithPropertiesDocument
{
    
    public BuildProjectWithPropertiesDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName BUILDPROJECTWITHPROPERTIES$0 = 
        new javax.xml.namespace.QName("integration.anthill3.urbancode.com", "buildProjectWithProperties");
    
    
    /**
     * Gets the "buildProjectWithProperties" element
     */
    public com.urbancode.anthill3.integration.BuildProjectWithPropertiesDocument.BuildProjectWithProperties getBuildProjectWithProperties()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.urbancode.anthill3.integration.BuildProjectWithPropertiesDocument.BuildProjectWithProperties target = null;
            target = (com.urbancode.anthill3.integration.BuildProjectWithPropertiesDocument.BuildProjectWithProperties)get_store().find_element_user(BUILDPROJECTWITHPROPERTIES$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setBuildProjectWithProperties(com.urbancode.anthill3.integration.BuildProjectWithPropertiesDocument.BuildProjectWithProperties buildProjectWithProperties)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.urbancode.anthill3.integration.BuildProjectWithPropertiesDocument.BuildProjectWithProperties)get_store().add_element_user(BUILDPROJECTWITHPROPERTIES$0);
            }
            target.set(buildProjectWithProperties);
        }
    }
     ...
     */
    public com.urbancode.anthill3.integration.BuildProjectWithPropertiesDocument.BuildProjectWithProperties addNewBuildProjectWithProperties()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class BuildProjectWithPropertiesImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.urbancode.anthill3.integration.BuildProjectWithPropertiesDocument.BuildProjectWithProperties
    {
        
        public BuildProjectWithPropertiesImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
