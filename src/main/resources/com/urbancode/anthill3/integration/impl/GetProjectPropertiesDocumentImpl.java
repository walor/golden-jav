 ...
 */
public class GetProjectPropertiesDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.urbancode.anthill3.integration.GetProjectPropertiesDocument
{
    
    public GetProjectPropertiesDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName GETPROJECTPROPERTIES$0 = 
        new javax.xml.namespace.QName("integration.anthill3.urbancode.com", "getProjectProperties");
    
    
    /**
     * Gets the "getProjectProperties" element
     */
    public com.urbancode.anthill3.integration.GetProjectPropertiesDocument.GetProjectProperties getGetProjectProperties()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.urbancode.anthill3.integration.GetProjectPropertiesDocument.GetProjectProperties target = null;
            target = (com.urbancode.anthill3.integration.GetProjectPropertiesDocument.GetProjectProperties)get_store().find_element_user(GETPROJECTPROPERTIES$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setGetProjectProperties(com.urbancode.anthill3.integration.GetProjectPropertiesDocument.GetProjectProperties getProjectProperties)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.urbancode.anthill3.integration.GetProjectPropertiesDocument.GetProjectProperties)get_store().add_element_user(GETPROJECTPROPERTIES$0);
            }
            target.set(getProjectProperties);
        }
    }
     ...
     */
    public com.urbancode.anthill3.integration.GetProjectPropertiesDocument.GetProjectProperties addNewGetProjectProperties()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class GetProjectPropertiesImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.urbancode.anthill3.integration.GetProjectPropertiesDocument.GetProjectProperties
    {
        
        public GetProjectPropertiesImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
